          ...
          if (data.status == 'loggedin') {
            if (data.windows.length == 0) {
              ...
              data.windows.forEach(function(curWindow) {
                ...
                var winString = '<fieldset class="window" id="winr' + i + '"><legend class="windowname">' + curWindow.name + '</legend><span class="right"><img class="windowdelete" src="images/delete.png" title="Delete window"><img class="windowopen" src="images/add.png" title="Open window"><img class="windowemail" src="images/email.png" title="Email Tabs"></span><div class="tabs">';
                var ti = 0;
                curWindow.tabs.forEach(function(curTab) {
